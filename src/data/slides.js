...
const DECOR = [
  ...
  { id: 'circle-1', kind: 'svg', src: '/assets/circle_1.svg', left: 71, top: 13, w: 5, z: 36, depth: 46, float: true },
...
export const slides = [
...

  {
    ...
    elements: [
      { id: 'metro', kind: 'image', src: '/hero/Sreedharan/metro_left_top.webp', left: 15.5, top: 25.5, w: 37, z: 20, depth: 42, glow: true },
...

  {
    ...
    elements: [
      ...
      { id: 'heater', kind: 'image', src: '/hero/v-gaurd/heater_right.webp', left: 56.5, top: 36, w: 30, z: 22, depth: 38, glow: true },
